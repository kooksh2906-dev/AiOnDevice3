...
/*
 * Prefer the interrupt mask generated by the active BSP.  This keeps the
 * application correct when the Trace Buffer is connected to a different AXI
 * INTC input instead of silently assuming input 0.
 */
#if defined(XPAR_CIRCULAR_TRACE_BUFFER_0_IRQ_O_MASK)
#undef EDGE_SCOPE_TRACE_IRQ_MASK
#define EDGE_SCOPE_TRACE_IRQ_MASK XPAR_CIRCULAR_TRACE_BUFFER_0_IRQ_O_MASK
#endif
...
#if defined(XPAR_PROBE_SAMPLER_AXI_0_S00_AXI_BASEADDR)
#define EDGE_SCOPE_SAMPLER_BASEADDR \
    XPAR_PROBE_SAMPLER_AXI_0_S00_AXI_BASEADDR
#elif defined(XPAR_PROBE_SAMPLER_AXI_0_BASEADDR)
...
#if defined(XPAR_BASIC_TRIGGER_ENGINE_0_S_AXI_BASEADDR)
#define EDGE_SCOPE_TRIGGER_BASEADDR \
    XPAR_BASIC_TRIGGER_ENGINE_0_S_AXI_BASEADDR
#elif defined(XPAR_BASIC_TRIGGER_ENGINE_AXI_0_BASEADDR)
...
#define EDGE_SCOPE_TIMER_CLOCK_HZ XPAR_AXI_TIMER_0_CLOCK_FREQ_HZ
#elif defined(XPAR_XTMRCTR_0_CLOCK_FREQUENCY)
...
#define EDGE_SCOPE_BRAM_BASEADDR XPAR_AXI_BRAM_CTRL_0_S_AXI_BASEADDR
