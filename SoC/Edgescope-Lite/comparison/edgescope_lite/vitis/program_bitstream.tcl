# Program the bootable comparison-B bitstream into one connected Basys3.
...
puts "EDGESCOPE_PROGRAM: PASS"
puts "EDGESCOPE_PROGRAM: target=[current_hw_target]"
puts "EDGESCOPE_PROGRAM: bitstream=$bitstream"
close_hw_target
