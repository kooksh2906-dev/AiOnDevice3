...
# module references:
# test_pattern_generator_gpio_adapter
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_gpio_test_ctrl, and set properties
  set axi_gpio_test_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_test_ctrl ]
  set_property -dict [list \
  ...
  # Create instance: test_pattern_generator_gpio_adapter_0, and set properties
  set block_name test_pattern_generator_gpio_adapter
  set block_cell_name test_pattern_generator_gpio_adapter_0
  if { [catch {set test_pattern_generator_gpio_adapter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $test_pattern_generator_gpio_adapter_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: ila_reference_0, and set properties
  set ila_reference_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_reference_0 ]
  set_property -dict [list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_gpio_test_ctrl_GPIO [get_bd_intf_pins axi_gpio_test_ctrl/GPIO] [get_bd_intf_pins test_pattern_generator_gpio_adapter_0/CONTROL_GPIO]
  connect_bd_intf_net -intf_net axi_gpio_test_ctrl_GPIO2 [get_bd_intf_pins axi_gpio_test_ctrl/GPIO2] [get_bd_intf_pins test_pattern_generator_gpio_adapter_0/STATUS_GPIO]
  ...
  connect_bd_intf_net -intf_net microblaze_riscv_0_axi_periph_M02_AXI [get_bd_intf_pins microblaze_riscv_0_axi_periph/M02_AXI] [get_bd_intf_pins axi_timer_0/S_AXI]
  connect_bd_intf_net -intf_net microblaze_riscv_0_axi_periph_M03_AXI [get_bd_intf_pins microblaze_riscv_0_axi_periph/M03_AXI] [get_bd_intf_pins axi_gpio_test_ctrl/S_AXI]
  ...
  [get_bd_pins rst_clk_wiz_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_riscv_0_Clk  [get_bd_pins clk_wiz/clk_out1] \
  ...
  [get_bd_pins ila_reference_0/clk]
  ...
  connect_bd_net -net rst_clk_wiz_100M_mb_reset  [get_bd_pins rst_clk_wiz_100M/mb_reset] \
  ...
  connect_bd_net -net test_pattern_generator_gpio_adapter_0_probe_test_o  [get_bd_pins test_pattern_generator_gpio_adapter_0/probe_test_o] \
  [get_bd_pins ila_reference_0/probe0]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs axi_gpio_test_ctrl/S_AXI/Reg] -force
